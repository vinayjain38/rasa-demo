...
* greet
    - action_greet_user
* ask_faq_ee OR ask_faq_human_languages_rasa OR ask_faq_is_programming_required OR ask_faq_tutorialcore OR ask_faq_tutorialnlu OR ask_faq_opensource OR ask_faq_voice OR ask_faq_slots OR  ask_faq_channels OR  ask_faq_differencecorenlu OR ask_faq_python_version OR ask_faq_community_size OR ask_faq_what_is_forum OR ask_faq_tutorials
    - action_faqs
...
* ask_faq_human_languages_rasa OR ask_faq_is_programming_required
    - action_faqs
* explain
